...
<body class="background">
	...
	<h3>Delete Flight</h3>
	<h4>${message}</h4>
	<form action="actionDelete" method="POST" id="deleteflightform">
		Enter Flight ID to delete flight <input type="text" name="flightId"
			required="required" autofocus="autofocus" placeholder="Flight ID" />
		<br> <br> <input type="submit" value="Delete Flight" />
	</form>
...
<script>
	$('#deleteflightform').submit(function() { // catch the form's submit event

...
<body class="background">
	...
	<h4>${message}</h4>
	<form action="actionAdd" method="POST" id="addflightform">
		<table>
			<tr>
				<td>Flight ID:</td>
		...
		<br><input type="submit" value="Add Flight" class="button-link" />
	</form>
</body>
...
<script>
	$('#addflightform').submit(function() { // catch the form's submit event
